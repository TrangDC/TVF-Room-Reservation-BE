...
import (
	...
	"gitlab.techvify.dev/its/internship/q2-2024/project/meeting-room-reservation/meeting-room-reservation-be/ent/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Booking, c.Office, c.Role, c.Room, c.User, c.UserRole,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		Booking, Office, Role, Room, User, UserRole []ent.Hook
	}
	inters struct {
		Booking, Office, Role, Room, User, UserRole []ent.Interceptor
	}
)
