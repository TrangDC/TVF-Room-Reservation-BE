...
func (ru *RoleUpdate) SetMachineName(s string) *RoleUpdate {
	ru.mutation.SetMachineName(s)
	return ru
}

// SetNillableMachineName sets the "machine_name" field if the given value is not nil.
func (ru *RoleUpdate) SetNillableMachineName(s *string) *RoleUpdate {
	if s != nil {
		ru.SetMachineName(*s)
	}
	return ru
...
func (ru *RoleUpdate) check() error {
	if v, ok := ru.mutation.MachineName(); ok {
		if err := role.MachineNameValidator(v); err != nil {
			return &ValidationError{Name: "machine_name", err: fmt.Errorf(`ent: validator failed for field "Role.machine_name": %w`, err)}
		}
	}
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ru.mutation.MachineName(); ok {
		_spec.SetField(role.FieldMachineName, field.TypeString, value)
	}
...
// SetMachineName sets the "machine_name" field.
func (ruo *RoleUpdateOne) SetMachineName(s string) *RoleUpdateOne {
	ruo.mutation.SetMachineName(s)
	return ruo
}

// SetNillableMachineName sets the "machine_name" field if the given value is not nil.
func (ruo *RoleUpdateOne) SetNillableMachineName(s *string) *RoleUpdateOne {
	if s != nil {
		ruo.SetMachineName(*s)
	}
	return ruo
}
...
func (ruo *RoleUpdateOne) check() error {
	if v, ok := ruo.mutation.MachineName(); ok {
		if err := role.MachineNameValidator(v); err != nil {
			return &ValidationError{Name: "machine_name", err: fmt.Errorf(`ent: validator failed for field "Role.machine_name": %w`, err)}
		}
	}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if value, ok := ruo.mutation.MachineName(); ok {
		_spec.SetField(role.FieldMachineName, field.TypeString, value)
	}
