...
func MachineName(v string) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldMachineName, v))
}
...
func MachineNameEQ(v string) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldMachineName, v))
}

// MachineNameNEQ applies the NEQ predicate on the "machine_name" field.
func MachineNameNEQ(v string) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldMachineName, v))
}

// MachineNameIn applies the In predicate on the "machine_name" field.
func MachineNameIn(vs ...string) predicate.Role {
	return predicate.Role(sql.FieldIn(FieldMachineName, vs...))
}

// MachineNameNotIn applies the NotIn predicate on the "machine_name" field.
func MachineNameNotIn(vs ...string) predicate.Role {
	return predicate.Role(sql.FieldNotIn(FieldMachineName, vs...))
}

// MachineNameGT applies the GT predicate on the "machine_name" field.
func MachineNameGT(v string) predicate.Role {
	return predicate.Role(sql.FieldGT(FieldMachineName, v))
}

// MachineNameGTE applies the GTE predicate on the "machine_name" field.
func MachineNameGTE(v string) predicate.Role {
	return predicate.Role(sql.FieldGTE(FieldMachineName, v))
}

// MachineNameLT applies the LT predicate on the "machine_name" field.
func MachineNameLT(v string) predicate.Role {
	return predicate.Role(sql.FieldLT(FieldMachineName, v))
}

// MachineNameLTE applies the LTE predicate on the "machine_name" field.
func MachineNameLTE(v string) predicate.Role {
	return predicate.Role(sql.FieldLTE(FieldMachineName, v))
}

// MachineNameContains applies the Contains predicate on the "machine_name" field.
func MachineNameContains(v string) predicate.Role {
	return predicate.Role(sql.FieldContains(FieldMachineName, v))
}

// MachineNameHasPrefix applies the HasPrefix predicate on the "machine_name" field.
func MachineNameHasPrefix(v string) predicate.Role {
	return predicate.Role(sql.FieldHasPrefix(FieldMachineName, v))
}

// MachineNameHasSuffix applies the HasSuffix predicate on the "machine_name" field.
func MachineNameHasSuffix(v string) predicate.Role {
	return predicate.Role(sql.FieldHasSuffix(FieldMachineName, v))
}

// MachineNameEqualFold applies the EqualFold predicate on the "machine_name" field.
func MachineNameEqualFold(v string) predicate.Role {
	return predicate.Role(sql.FieldEqualFold(FieldMachineName, v))
}

// MachineNameContainsFold applies the ContainsFold predicate on the "machine_name" field.
func MachineNameContainsFold(v string) predicate.Role {
	return predicate.Role(sql.FieldContainsFold(FieldMachineName, v))
}
