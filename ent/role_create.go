...
func (rc *RoleCreate) SetMachineName(s string) *RoleCreate {
	rc.mutation.SetMachineName(s)
	return rc
}
...
func (rc *RoleCreate) check() error {
	if _, ok := rc.mutation.MachineName(); !ok {
		return &ValidationError{Name: "machine_name", err: errors.New(`ent: missing required field "Role.machine_name"`)}
	}
	if v, ok := rc.mutation.MachineName(); ok {
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.MachineName(); ok {
